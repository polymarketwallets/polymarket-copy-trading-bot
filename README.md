# Polymarket copy-trading bot (Node.js / TypeScript)

[![npm](https://img.shields.io/npm/v/pmwallets-copytrade.svg)](https://www.npmjs.com/package/pmwallets-copytrade) [![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
...
[`pmwallets-copytrade` on npm](https://www.npmjs.com/package/pmwallets-copytrade) · [中文说明](README.zh.md) · Python version: [polymarket-copy-trading-bot-python](https://github.com/polymarketwallets/polymarket-copy-trading-bot-python) ·
SDK: [pmwallets-node](https://github.com/polymarketwallets/pmwallets-node)
...
The same `config.yaml`, state files and lock file work with the Python version. `testdata/` holds the
